    ...
    <a class="navbar-brand d-flex align-items-center" href="../index.php">
        ...
        <div id="navcol-1" class="collapse navbar-collapse" style="padding-left: 0px;">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"></li>
                <li class="nav-item"><a class="nav-link active" href="response.php">Response</a></li>
                <li class="nav-item"></li>
            </ul><a class="btn btn-primary" href="../logout.php">logout</a>
        </div>
    </div>
</nav><!-- End: Navbar Centered Links --><!-- Start: Contact Details --><section class="py-5 mt-5">
    <div class="container py-5">
        <div class="row">
            <div class="col-md-8 col-xl-6 text-center mx-auto"><span class="fw-bold" style="font-size: xx-large;"><u>Welcome <?php echo $_SESSION["nom"].' '.$_SESSION["prenom"];?></u></span>
                <h2 class="display-6 fw-bold mb-4"><span class="underline pb-2">Response</span></h2>
            </div>
        </div>
            ...
            <div class="table-responsive table table-hover table-bordered results">
                <table class="table table-hover table-bordered">
                    <thead class="bill-header cs">
                        <tr>
                            <th id="trs-hd-1" class="col-lg-1">Id de reclamation</th>
                            <th id="trs-hd-7" class="col-lg-8">Response</th>
                        </tr>
                    </thead>
                    <tbody>
