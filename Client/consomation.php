...
</nav><!-- End: Navbar Centered Links --><section class="py-5 mt-5">
    <div class="container py-5">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <span class="fw-bold" style="font-size: xx-large;"><u>Welcome <?php echo $_SESSION["nom"].' '.$_SESSION["prenom"];?></u></span>
                <h2 class="fw-bold"><br /><span class="underline pb-2">Ajouter Consomation</span></h2>
            </div>
        </div>
        <div class="table-responsive">
            <div>
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td data-label="Attributes" scope="row">November</td>
                            <td data-label="Base Class">500</td>
                            <td data-label="Base Class"><input type="file" /></td>
                        </tr>
                        <tr>
                            <td data-label="Attributes" scope="row">december</td>
                            <td data-label="Base Class">400</td>
                            <td data-label="Base Class"><input type="file" /></td>
                        </tr>
                    </tbody>
                </table>
...
</section><!-- Start: Footer Multi Column --><footer><div class="container py-4 py-lg-5"><hr><div class="text-muted d-flex justify-content-between align-items-center pt-3"><p class="mb-0">Copyright © 2023&nbsp;</p><ul class="list-inline mb-0"><li class="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
