        ...
        <div class="container">
            ...
            <div id="navcol-1" class="collapse navbar-collapse" style="padding-left: 0px;">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link active" style="color:red" href="avertissement.php">Avertissement</a></li>
                    <li class="nav-item"></li>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto"><span class="fw-bold" style="font-size: xx-large;"><u>Welcome <?php echo $_SESSION["nom"] . ' ' . $_SESSION["prenom"]; ?></u></span>
                    <h2 class="display-6 fw-bold mb-4"><span class="underline pb-2">Avertissement</span></h2>
                </div>
            </div>
            <div class="col-md-12 search-table-col">
                ...
                <div class="table-responsive table table-hover table-bordered results">
                    ...
                    $sql = 'SELECT *
                    FROM reclamation  where client_id = ' . $_SESSION["id"] . ' and contenue_reponse is not null and contenue = "Avertissement"';
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<thead class='bill-header cs'>
                                <tr>
                                <th id='trs-hd-1' class='col-lg-1' style='color:black'>Id avertissement</th>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td><a class="btn btn-danger" type="button" name="submitApp" href="traitement.php?id=' . $row['id'] . '">Delete Avertissement</a></td>';
                            echo '</form>';
                            echo "</tr>";
                        }
...
Vous n\'avez pas un avertissement actuellement.
</div>';
                    }
                    ?>
                </div>
    ...
    Swal.fire({
            position: 'top-end',
            icon: 'success',
            title: 'Avertissement' a été bien supprimé',
            showConfirmButton: false,
            timer: 1500
          })
        </script>";
