        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="../index.php"><span>ELECTRICAL WEB SITE</span></a>
            ...
            <div id="navcol-1" class="collapse navbar-collapse" style="padding-left: 0px;">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link active" href="reclamation.php">Ajouter une reclamation</a></li>
                    <li class="nav-item"></li>
                    ...
                    <div>
                        <form class="p-3 p-xl-4" method="post" action="traitement.php">
                            <div class="mb-3">
                                ...
                                <select id="subject" class="shadow form-control" name="subject" placeholder="subject" onchange="checkSubject()">
                            ...
                            <div id="otherSubjectDiv" style="display:none;">
                                ...
                                <input type="text" id="otherSubject" class="shadow form-control" name="otherSubject" placeholder="Saisir subject">
                            </div><br>
